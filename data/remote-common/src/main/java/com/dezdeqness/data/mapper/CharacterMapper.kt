...
class CharacterMapper @Inject constructor(
    ...
    fun fromResponse(characterRemote: CharacterRemote) = CharacterEntity(
    ...
    fun fromResponse(characterRemote: DetailsQuery.Character) = CharacterEntity(
    ...
    fun fromResponse(character: CharacterDetailsRemote) = CharacterDetailsEntity(
