...
fun AnimatedContentTransitionScope<*>.slideInFromBottom(): EnterTransition = slideIntoContainer(
    animationSpec = tween(DURATION_SHORT, easing = EaseIn),
    towards = AnimatedContentTransitionScope.SlideDirection.Up,
)

fun AnimatedContentTransitionScope<*>.slideOutToBottom(): ExitTransition = slideOutOfContainer(
    animationSpec = tween(DURATION_SHORT, easing = EaseOut),
    towards = AnimatedContentTransitionScope.SlideDirection.Down,
)

fun AnimatedContentTransitionScope<*>.slideInFromTop(): EnterTransition = slideIntoContainer(
    animationSpec = tween(DURATION_SHORT, easing = EaseIn),
    towards = AnimatedContentTransitionScope.SlideDirection.Down,
)

fun AnimatedContentTransitionScope<*>.slideOutToTop(): ExitTransition = slideOutOfContainer(
    animationSpec = tween(DURATION_SHORT, easing = EaseOut),
    towards = AnimatedContentTransitionScope.SlideDirection.Up,
)
