...
-keep class com.dezdeqness.data.model.** { *; }
-keep class com.dezdeqness.data.AccountApiService { *; }
-keep class com.dezdeqness.data.AnimeApiService { *; }
-keep class com.dezdeqness.data.AuthorizationApiService { *; }
-keep class com.dezdeqness.data.CalendarApiService { *; }
-keep class com.dezdeqness.data.UserRatesApiService { *; }
...
-keep class com.dezdeqness.presentation.features.animestats.AnimeStatsTransferModel
