...
import com.dezdeqness.feature.searchfilter.presentation.preview.SearchFilterPreviewData
...
fun SectionPreview() {
    AppTheme {
        Column(
            ...
            Section(
                sectionData = MutableStateFlow(SearchFilterPreviewData.chipSection),
                onScrollNeed = {},
                onClick = { _, _, _ -> },
            )
            Section(
                sectionData = MutableStateFlow(SearchFilterPreviewData.checkboxSection),
                onScrollNeed = {},
                onClick = { _, _, _ -> },
            )
        }
